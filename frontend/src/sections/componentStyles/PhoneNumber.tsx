...
export default function PhoneNumber({ name, value, onChange }: PhoneNumberProps) {
  ...
  return (
    <div className="space-y-2" dir="ltr">
      <RPNInput.default
        className="flex rounded-lg shadow-sm shadow-black/5 mt-2 bg-[#141B2D] border border-gray-700 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
        international
